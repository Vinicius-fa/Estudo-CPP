...
void renderSphere(float angleX, float angleY) {
    ...
    float radius = 1.0f;          // Raio da esfera no espaço 3D
    float distance = 6.5f;        // Distância da câmera até a esfera
...
int main() {
    // Código especial para ativar o suporte ANSI no terminal do Windows
    #ifdef _WIN32
