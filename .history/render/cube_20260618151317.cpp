...
private:
    ...
    const double FOV_DISTANCE = 200.0;
...
public:
    ...
    void draw() {
        ...
        // Desenha as arestas primeiro (linhas entre vértices)
        drawEdges(screen);

        // Desenha os vértices por cima (opcional, realça as quinas com '#')
        ...
        // Limpa a tela e imprime usando ANSI escape code
        cout << "\033[2J\033[H"; 
